...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("Exception Handling Example")
                .description("Demonstration of custom exception handling")
                .contact(new Contact("Wilfred Morgan",
                        "http://www.wilfredmorgan.com",
                        "wilfred@wilfredmorgan.com"))
                .license("MIT")
                .licenseUrl("https://github.com/wmemorgan/java-school/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}
